const questions = [
    {
        question: '<img src="static/image/apple1.jpg" alt = "Question 1" > ',
        answers:[
            {imgSrc: "static/image/1.png", correct: false},
    ...
    {
        question: '<img src="static/image/apple 2.jpg" alt = "Question 2" > ',
        answers:[
            {imgSrc: "static/image/6.png", correct: true},
            {imgSrc: "static/image/9.png", correct: false},
            {imgSrc: "static/image/5.png", correct: false},
        ]

    },
    {
        question: '<img src="static/image/apple 3.jpg" alt = "Question 3" > ',
        answers:[
            {imgSrc: "static/image/5.png", correct: false},
            {imgSrc: "static/image/3.png", correct: true},
            {imgSrc: "static/image/4.png", correct: false},
        ]

    },
    {
        question: '<img src="static/image/apple 4.jpg" alt = "Question 4" > ',
        answers:[
            {imgSrc: "static/image/8.png", correct: false},
            {imgSrc: "static/image/4.png", correct: false},
    ...
    {
        question: '<img src="static/image/apple 5.jpg" alt = "Question 4" > ',
        answers:[
            {imgSrc: "static/image/3.png", correct: false},
            {imgSrc: "static/image/6.png", correct: false},
            {imgSrc: "static/image/4.png", correct: true},
        ]
